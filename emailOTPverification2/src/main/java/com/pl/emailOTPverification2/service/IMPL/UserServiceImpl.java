...
import com.pl.emailOTPverification2.repository.UsersRepository;
...
import com.pl.emailOTPverification2.service.UserService;
...
public class UserServiceImpl implements UserService
{
    ...
    public void verify(String email, String otp)
    {
      ...
      if(users == null) {
          ...
          throw new RuntimeException("User is always verified");
